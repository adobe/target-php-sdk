...
/**
 * ViewRequestAllOf Class Doc Comment
 *
 * @category Class
 * @package  Adobe\Target\Delivery\v1
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ViewRequestAllOf implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ViewRequest_allOf';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ViewRequestAllOf., must be smaller than or equal to 128.');
        }
    ...
    public function setKey($key)
    {
        if (!is_null($key) && (mb_strlen($key) > 512)) {
            throw new \InvalidArgumentException('invalid length for $key when calling ViewRequestAllOf., must be smaller than or equal to 512.');
        }
