...
class Product implements ModelInterface, ArrayAccess
{
     ...
     * Sets id
     *
     * @param string|null $id Product id. Should not be blank.
     *
     * @return $this
     */
    public function setId($id)
    {
        if (!is_null($id) && (mb_strlen($id) > 128)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Product., must be smaller than or equal to 128.');
        }
     ...
     * Sets categoryId
     *
     * @param string|null $categoryId Category id. Should not be blank.
     *
     * @return $this
     */
    public function setCategoryId($categoryId)
    {
        if (!is_null($categoryId) && (mb_strlen($categoryId) > 128)) {
            throw new \InvalidArgumentException('invalid length for $categoryId when calling Product., must be smaller than or equal to 128.');
        }
